    ...
    execute(message, args){
        if(!args[0]){
            ...
            if(image == 1){
                ...
                var chosenImage = 'https://pa1.narvii.com/6248/2d96dcde51edeb7c91f194c71e7a15dddc367e13_hq.gif';
            } else if(image == 5){
             ...
             var chosenImage = 'https://media1.tenor.com/images/503bb007a3c84b569153dcfaaf9df46a/tenor.gif?itemid=17382412';
                ...
                var chosenImage = 'https://tenor.com/view/sakura-trick-sakura-trick-gif-14042664';
            } else if(image == 9){
                var chosenImage = 'https://media1.tenor.com/images/279c4716a469ace39b15e34d7fa3e7c4/tenor.gif?itemid=11487318';
            } else if(image == 10){
                var chosenImage = 'https://tenor.com/view/girls-kiss-anime-shocked-blush-gif-17500022';
            } else if(image == 11){
