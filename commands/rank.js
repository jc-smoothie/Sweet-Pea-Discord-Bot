module.exports = {
    ...
    execute(message, args){
        ...
        if(parts[1] == 'traveler'){
            ...
            message.channel.send("<:white_check_mark:765991657736241152>" + message.author.id + ">, Welcome, fellow Weeb~ Visit #react-role-assign to get language and region roles.");
            //✅
